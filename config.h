...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=16", "-g", "50x20", "-e", "nvim", "-c","VimwikiIndex", NULL };
// const char *spcmd2[] = {TERMINAL, "-n", "nvim -c VimwikiIndex", "-f", "monospace:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Rule rules[] = {
  ...
  { "Zathura", "org.pwmt.zathura", "/tmp/vim-latex-live-preview", 0, 0, 0, 1, -1 },
